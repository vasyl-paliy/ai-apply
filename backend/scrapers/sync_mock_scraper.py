"""
Synchronous Mock scraper for testing and demonstration purposes.
...
from .base_scraper import JobData
import logging


class SyncMockScraper:
    """Synchronous mock scraper that generates fake job data for testing."""
    ...
    def __init__(self):
        ...
        self.job_types = ["full_time", "part_time", "contract", "internship", "remote", "hybrid"]
    ...
    def search_jobs(
        ...
        print(f"Sync mock scraper searching for jobs with keywords: {keywords}, locations: {locations}")
...
We offer competitive compensation, comprehensive benefits, and opportunities for professional growth.
        ...
        print(f"Sync mock scraper generated {len(jobs)} jobs")
        return jobs 